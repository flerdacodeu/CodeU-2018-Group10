...
public class ParkingLotWithReservedSpacesTest {
  ...
  public void createGraphForNoReservedSpacesAssignmentExample() {
    ...
    ParkingLotWithReservedSpaces parkingLotStart = new ParkingLotWithReservedSpaces(initialMap);
    ...
    ParkingLotWithReservedSpaces parkingLotEnd = new ParkingLotWithReservedSpaces(goalMap);
  ...
  public void parkingLotWithCarInSpaceItInstReservedFor() {
    ...
    new ParkingLotWithReservedSpaces(goalMap);
  }
  ...
  public void notEnoughSpaces() {
    ...
    initialMap = new HashMap<>();
    initialMap.put(space1, car1);
    new ParkingLotWithReservedSpaces(initialMap);
  }
}